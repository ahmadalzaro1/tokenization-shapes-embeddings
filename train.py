...
Arabic harakat experiment on Apple Silicon MLX.
Usage: AUTORESEARCH_CONDITION=d1 uv run train.py
"""
...
# Initialize condition from environment before importing prepare utilities
import prepare
condition = os.environ.get("AUTORESEARCH_CONDITION", "d1")
prepare.init_condition(condition)
